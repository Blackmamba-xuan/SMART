...
from train.algorithms.dqn2 import DQN
...
class myThread (threading.Thread):
    ...
    def run(self):
        ...
        with open('checkpoints_AttentionDQN_exp7_7/logs/incremental' +'dqnBuffer' + str(epi_record) + '.pkl', 'wb') as file:
            pickle.dump(replay_buffer, file)
        print ("finish save file：")

def run(config):
    log_dir = 'checkpoints_AttentionDQN_exp7_12/'
