...
class Entity(object):
    ...
    def __init__(self,name,pos,lane_flag):
        ...
        self.speed_x=0.06
        self.pos=pos
        self.lidar_frames=[[3.5]*360for i in range(1)]
    ...
    def setLaneFlag(self, lane_flag_msg):
        ...
        print('enter set lane_flag: ', self.name, '  ', self.lane_flag)
    ...
    def reset(self):
        speed_x=random.uniform(0.06,0.13)
        msg=Float64()
        msg.data=speed_x
